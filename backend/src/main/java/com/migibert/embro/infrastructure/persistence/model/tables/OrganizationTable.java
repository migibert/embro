...
import com.migibert.embro.infrastructure.persistence.model.tables.InvitationTable.InvitationPath;
import com.migibert.embro.infrastructure.persistence.model.tables.PositionTable.PositionPath;
...
public class OrganizationTable extends TableImpl<OrganizationRecord> {
    ...
    private transient InvitationPath _invitation;

    /**
     * Get the implicit to-many join path to the <code>public.invitation</code>
     * table
     */
    public InvitationPath invitation() {
        if (_invitation == null)
            _invitation = new InvitationPath(this, null, Keys.INVITATION__FK_INVITATION_ORGANIZATION.getInverseKey());
    ...
    public PositionPath position() {
        if (_position == null)
            _position = new PositionPath(this, null, Keys.POSITION__FK_POSITION_ORGANIZATION.getInverseKey());
    ...
    public UserOrganizationPath userOrganization() {
        if (_userOrganization == null)
            _userOrganization = new UserOrganizationPath(this, null, Keys.USER_ORGANIZATION__FK_USER_ORGANIZATION_ORGANIZATION.getInverseKey());
