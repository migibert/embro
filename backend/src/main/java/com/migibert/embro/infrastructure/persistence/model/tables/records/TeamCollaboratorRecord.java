...
public class TeamCollaboratorRecord extends UpdatableRecordImpl<TeamCollaboratorRecord> {
    ...
    /**
     * Setter for <code>public.team_collaborator.key_player</code>.
     */
    public void setKeyPlayer(Boolean value) {
        set(3, value);
    }

    /**
     * Getter for <code>public.team_collaborator.key_player</code>.
     */
    public Boolean getKeyPlayer() {
     ...
     */
    public TeamCollaboratorRecord(UUID organizationId, UUID teamId, UUID collaboratorId, Boolean keyPlayer) {
        super(TeamCollaboratorTable.TEAM_COLLABORATOR);

        setOrganizationId(organizationId);
        setTeamId(teamId);
        setCollaboratorId(collaboratorId);
        setKeyPlayer(keyPlayer);
