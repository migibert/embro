...
public class CollaboratorTable extends TableImpl<CollaboratorRecord> {
    ...
    /**
     * The column <code>public.collaborator.position</code>.
     */
    public final TableField<CollaboratorRecord, String> POSITION = createField(DSL.name("position"), SQLDataType.VARCHAR(100).nullable(false), this, "");
